    ...
    <q-header elevated >
        <q-toolbar class="bg-primary shadow-transition glossy">
            ...
            <q-btn-group flat>
                ...
                <q-btn to="/register" color="white" flat v-if="token === ''">
                        <q-icon name="people" />
                        <q-tooltip transition-show="flip-right" transition-hide="flip-left" content-class="bg-secondary" content-style="font-size: 16px" anchor="top left" :offset="[30, 30]">
                            New User
                        </q-tooltip>
                </q-btn>
                <q-btn color="white" flat to="/dashboard" v-if="token !== ''">
                        <q-icon name="dashboard" />
                        <q-tooltip transition-show="flip-right" transition-hide="flip-left" content-class="bg-secondary" content-style="font-size: 16px" anchor="top left" :offset="[30, 30]">
                            Dashboard
                        </q-tooltip>
                </q-btn>
                <q-btn color="white" flat to="/login" v-else>
                        <q-icon name="lock" />
                        <q-tooltip transition-show="flip-right" transition-hide="flip-left" content-class="bg-secondary" content-style="font-size: 16px" anchor="top left" :offset="[30, 30]">
                            Login
                        </q-tooltip>
                </q-btn>
                <q-btn color="white" flat v-if="token != ''" @click="dialog = true">
